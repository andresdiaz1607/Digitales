...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _1963443_archive_1.so
_1963443_archive_1.so : archive.6/_1963443_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_1963443_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_1963443_archive_1.so $@

...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _296748_archive_1.so
_296748_archive_1.so : archive.17/_296748_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_296748_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_296748_archive_1.so $@

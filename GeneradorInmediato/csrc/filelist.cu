...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _266946_archive_1.so
_266946_archive_1.so : archive.1/_266946_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_266946_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_266946_archive_1.so $@
